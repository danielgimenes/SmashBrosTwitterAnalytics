...
public class LegacyStatus implements Status {
	private static final long serialVersionUID = -7154828852823585815L;
	private Tweet tweet;

	public LegacyStatus(Tweet tweet) {
		this.tweet = tweet;
	}
